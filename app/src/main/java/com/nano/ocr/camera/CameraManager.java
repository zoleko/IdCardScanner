...
import com.nano.ocr.CaptureActivity;

import java.io.IOException;

import static com.nano.ocr.CaptureActivity.DEFAULT_TOGGLE_REVERSED_IMAGE;
...
public final class CameraManager {
  ...
  private static final int MIN_FRAME_WIDTH = 1200; // originally 240
  private static final int MIN_FRAME_HEIGHT = 700; // originally 240
  ...
  public synchronized void openDriver(SurfaceHolder holder) throws IOException {
    ...
    reverseImage = DEFAULT_TOGGLE_REVERSED_IMAGE;
  }
   ...
   */
  public synchronized void requestOcrDecode(CaptureActivity activity,int face) {
    Camera theCamera = camera;
    if (theCamera != null && previewing) {
      previewCallback.setActivity(activity,face);
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      Log.e(TAG, "getFramingRect: "+width );
      if (width < MIN_FRAME_WIDTH) {
        width = MIN_FRAME_WIDTH;
      }
      int height = screenResolution.y *(1/ 3);
      Log.e(TAG, "getFramingRect: "+width +"|"+height);
  ...
  public synchronized void adjustFramingRect(int deltaWidth, int deltaHeight) {
    if (initialized) {
      ...
      Log.e(TAG, "getFramingRectInPreview: "+newWidth+"||"+newHeight);
      framingRectInPreview = null;
    } else {
