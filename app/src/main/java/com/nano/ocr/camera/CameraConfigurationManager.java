...
import static com.nano.ocr.CaptureActivity.DEFAULT_DISABLE_CONTINUOUS_FOCUS;
import static com.nano.ocr.CaptureActivity.DEFAULT_TOGGLE_AUTO_FOCUS;
import static com.nano.ocr.CaptureActivity.DEFAULT_TOGGLE_LIGHT;
...
final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera) {
        ...
        if (DEFAULT_TOGGLE_AUTO_FOCUS) {
            if (DEFAULT_DISABLE_CONTINUOUS_FOCUS) {
    ...
    void setTorch(Camera camera, boolean newSetting) {
        ...
        camera.setParameters(parameters);
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        boolean currentSetting = DEFAULT_TOGGLE_LIGHT;
